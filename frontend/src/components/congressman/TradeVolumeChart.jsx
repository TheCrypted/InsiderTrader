...
const TradeVolumeChart = ({ data, loading }) => {
  ...
  if (loading) {
    return (
      <div className="bg-white p-8 flex items-center justify-center animate-pulse">
  ...
  return (
    <div className={`bg-white p-6 transition-all duration-500 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
      <div className="mb-2">
